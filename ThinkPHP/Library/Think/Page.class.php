...
namespace Think;
 class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'件商品','prev'=>'上一页','first'=>'首页','next'=>'下一页','last'=>'<span id="lastspan">尾页</span>','theme'=>'<ul class="pagination"><li><span> %totalRow% %header% %nowPage%/%totalPage% 页</span></li> %first% %upPage%   %prePage%  %linkPage%  %nextPage% %downPage% %end%</ul>');
    // 默认分页变量名
    protected $varPage;
    /**
     * 架构函数
