...
<span onmouseover="$(this).addClass('active')"  class="active"><a href="<?php echo HOME;?>index/user_product" class=mpost>闲置物品</a></span>
...
<div class=UserPath>您的位置：<a href="<?php echo HOME;?>index/member">会员中心</a> >> <a href=User_Product>闲置物品</a></div><table width='100%' cellpadding=3 cellspacing=1><tr><td valign=top colspan=2>
...
<TBODY>
	...
	<TH > <a href="<?php echo HOME;?>goods/details?id=<?php echo $value[0]; ?>"><?php echo $value[1]; ?></a></TH>
	<TH width=140><?php echo $value[16]; ?></TH>
	<TH width=110>状态:发布</TH>
	<TH width=110>操作:&nbsp;<a href="<?php echo HOME;?>index/user_product?del=<?php echo $value[0]; ?>" onclick="delcfm()">删除</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo HOME;?>goods/updata?id=<?php echo $value[0];?>">修改</a></TH>
	</TR>
	<?php } ?>
</TBODY></TABLE>
