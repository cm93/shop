...
<div class=UserPath>您的位置：<a href="./member">会员中心</a> >> <a href=PayOnline>账户充值</a></div><DIV class=right_top><SPAN class='button'>
<SPAN class='button'><A class=btn-b href='PayOnline'>账户充值</A></SPAN>
<SPAN class='button on'><A class=btn-b href='./payonline?action=detail'>账户明细</A></SPAN>
</DIV>
<table width='100%' cellpadding=3 cellspacing=1 class=td30>
<tr><td colspan=2 valign=top>
<IFRAME id=charge onload="setIframeHeight('charge')" src="/shop/home/index/payrecodes" frameBorder=0 width=100% height=700 name=charge scrolling=no></IFRAME>
</td></tr></Table>
</div>
</DIV>
