...
<div class="admin">
    <form method="post" id="dels" action="<?php echo ADMIN; ?>goods/del_contents">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover">
            ...
            <tr>
                <td><input type="checkbox" name="id" class="id" value="<?php echo $value[0]; ?>"  /></td>
                <td><?php echo $value['2']; ?></td>
                <td><?php echo $value['1']; ?></td>
                <td><?php echo explode(" ", $value['10'])[0]; ?></td>
                <td><a class="button border-blue button-little" href="<?php echo ADMIN; ?>goods/content?id=<?php echo $value[0]; ?>" >修改</a> <a class="button border-yellow button-little" href="<?php echo ADMIN;?>/goods/content_del?id=<?php echo $value[0]; ?>" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a></td>
            </tr>
              <?php } ?>
        </table>
